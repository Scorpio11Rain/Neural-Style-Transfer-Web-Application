...
if clicked:
    with st.spinner("Image processing, this might take a few minutes, please wait."):
        st.balloons()
        merged = neural_style_transfer.stylize(raw_img, style, EPOCHS)
    ...
    st.subheader("Example ouputs from above are below")
    st.text("Please upload your own images and  run button on the left to have your own stylized image!")
